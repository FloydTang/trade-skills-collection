...
REQUIRED_FILES = [
    ...
    SKILL_ROOT / "SKILL.md",
    SKILL_ROOT / "验收记录.md",
    SKILL_ROOT / "schemas" / "email-draft-input.schema.json",
    SKILL_ROOT / "examples" / "first-touch-output.md",
    SKILL_ROOT / "examples" / "follow-up-output.md",
    SKILL_ROOT / "examples" / "solar-first-touch-output.md",
    SKILL_ROOT / "examples" / "textile-follow-up-output.md",
