...
- Source Type: web
- Source Name: fixture
- Source URL/Note: https://atelier-loom.de
- Freshness: unknown
- Confidence: medium
- Match Basis: 命中搜索查询：washed linen table textile Germany brand
- Evidence Grade: A
...
- Match Reason: 证据等级 A：来源：fixture；命中搜索查询：washed linen table textile Germany brand；有官网主体线索；有 LinkedIn 公司页线索；搜索结果出现可见联系人或角色线索；命中当前搜索策略中的目标关键词组合。
- Missing Fields: (none)
...
- Source Type: web
- Source Name: fixture
- Source URL/Note: https://marketplace.example/nordhaus
- Freshness: unknown
- Confidence: medium
- Match Basis: 命中搜索查询：table linen brand Germany importer distributor brand buyer
- Evidence Grade: B
- Next Action: ready_for_screening
...
- Evidence Summary: 当前候选主要基于官网、数据源 fixture形成。 建议动作：ready_for_screening。
- Match Reason: 证据等级 B：来源：fixture；命中搜索查询：table linen brand Germany importer distributor brand buyer；有官网主体线索；命中当前搜索策略中的目标关键词组合。
...
- Source Type: web
- Source Name: fixture
- Source URL/Note: https://nordhaus-tableware.de
- Freshness: unknown
- Confidence: medium
- Match Basis: 命中搜索查询：washed linen table textile Germany brand
- Evidence Grade: B
...
- Evidence Summary: 当前候选主要基于官网、数据源 fixture形成。 建议动作：ready_for_screening。
- Match Reason: 证据等级 B：来源：fixture；命中搜索查询：washed linen table textile Germany brand；有官网主体线索；命中当前搜索策略中的目标关键词组合。
- Missing Fields: linkedin_url, visible_contact_clues
- Follow-up Suggestion: 先补 LinkedIn 公司页或可见联系人线索，再进入线索整理。
...
- Source Name: fixture
- Source URL/Note: https://www.linkedin.com/company/nordhaus-tableware
- Freshness: unknown
- Confidence: medium
- Match Basis: 命中搜索查询：site:linkedin.com/company washed linen table textile Germany brand
- Evidence Grade: B
- Next Action: ready_for_screening
- Visible Contact Clues: (none)
...
- Evidence Summary: 当前候选主要基于LinkedIn、数据源 fixture形成。 建议动作：ready_for_screening。
- Match Reason: 证据等级 B：来源：fixture；命中搜索查询：site:linkedin.com/company washed linen table textile Germany brand；有 LinkedIn 公司页线索；命中当前搜索策略中的目标关键词组合。
...
```json
{
  ...
  "operator_notes": "Prefer design-led brands.",
  "product_or_offer": "washed linen table textile",
  "target_customer_type": "brand",
  ...
  "leads": [
    {
      ...
      "notes": "Prefer design-led brands. | Design-led table linen brand for premium home textile collections in Germany. | 先进入线索整理，再优先核对官网、LinkedIn 与联系人线索的一致性。",
      "evidence_grade": "A",
      "match_reason": "证据等级 A：来源：fixture；命中搜索查询：washed linen table textile Germany brand；有官网主体线索；有 LinkedIn 公司页线索；搜索结果出现可见联系人或角色线索；命中当前搜索策略中的目标关键词组合。",
      ...
      "source_type": "web",
      "source_name": "fixture",
      "source_url_or_note": "https://atelier-loom.de",
      "freshness": "unknown",
      "confidence": "medium",
      "match_basis": "命中搜索查询：washed linen table textile Germany brand"
    },
    {
      ...
      "linkedin_url": "",
      "notes": "Prefer design-led brands. | NordHaus Tableware sells premium table linen collections for retail buyers. | 先补 LinkedIn 公司页或可见联系人线索，再进入线索整理。",
      "evidence_grade": "B",
      "match_reason": "证据等级 B：来源：fixture；命中搜索查询：table linen brand Germany importer distributor brand buyer；有官网主体线索；命中当前搜索策略中的目标关键词组合。",
      "evidence_summary": "当前候选主要基于官网、数据源 fixture形成。 建议动作：ready_for_screening。",
      "discovery_missing_fields": [
        "linkedin_url",
      ...
      "source_type": "web",
      "source_name": "fixture",
      "source_url_or_note": "https://marketplace.example/nordhaus",
      "freshness": "unknown",
      "confidence": "medium",
      "match_basis": "命中搜索查询：table linen brand Germany importer distributor brand buyer"
    },
    {
      ...
      "linkedin_url": "",
      "notes": "Prefer design-led brands. | NordHaus presents natural table linen ranges for boutique home stores. | 先补 LinkedIn 公司页或可见联系人线索，再进入线索整理。",
      "evidence_grade": "B",
      "match_reason": "证据等级 B：来源：fixture；命中搜索查询：washed linen table textile Germany brand；有官网主体线索；命中当前搜索策略中的目标关键词组合。",
      "evidence_summary": "当前候选主要基于官网、数据源 fixture形成。 建议动作：ready_for_screening。",
      "discovery_missing_fields": [
        "linkedin_url",
        "visible_contact_clues"
      ...
      "source_type": "web",
      "source_name": "fixture",
      "source_url_or_note": "https://nordhaus-tableware.de",
      "freshness": "unknown",
      "confidence": "medium",
      "match_basis": "命中搜索查询：washed linen table textile Germany brand"
    },
    {
      ...
      "notes": "Prefer design-led brands. | NordHaus Tableware focuses on home tabletop collections and design buyers. | 先补官网或公司域名，再进入线索整理。",
      "evidence_grade": "B",
      "match_reason": "证据等级 B：来源：fixture；命中搜索查询：site:linkedin.com/company washed linen table textile Germany brand；有 LinkedIn 公司页线索；命中当前搜索策略中的目标关键词组合。",
      "evidence_summary": "当前候选主要基于LinkedIn、数据源 fixture形成。 建议动作：ready_for_screening。",
      "discovery_missing_fields": [
        "company_website",
        "visible_contact_clues"
      ],
      ...
      "source_name": "fixture",
      "source_url_or_note": "https://www.linkedin.com/company/nordhaus-tableware",
      "freshness": "unknown",
      "confidence": "medium",
      "match_basis": "命中搜索查询：site:linkedin.com/company washed linen table textile Germany brand"
    }
  ]
}
```
