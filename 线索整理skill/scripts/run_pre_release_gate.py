...
OPENCLAW_SCRIPT = SKILL_ROOT / "for-openclaw" / "scripts" / "build_lead_screening_from_openclaw.py"
...
REQUIRED_FILES = [
    ...
    SKILL_ROOT / "SKILL.md",
    SKILL_ROOT / "验收记录.md",
    SKILL_ROOT / "schemas" / "lead-screening-input.schema.json",
    SKILL_ROOT / "examples" / "sample-output.md",
