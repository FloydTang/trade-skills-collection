...
2. `../工作间/` 是当前 `外贸skill` 分类的长期记录层，对应 Obsidian `工具工作间/02_场景拆解/外贸业务主干Skill`，不是 Obsidian 顶层“工具工作间”本身。
3. Obsidian `工具工作间/02_场景拆解/外贸业务主干Skill` 是记录承接层，服务后续品牌、课程、产品表达，不承接执行层日报和脚本。
...
凡是属于当前 `外贸skill` 分类、并且会被长期复用的记录型文档或说明型文档，都应在 Obsidian `工具工作间/02_场景拆解/外贸业务主干Skill` 有对应展现。
...
9. **判断 Obsidian 展现**：
   - 如果某条记录或说明未来会被课程、品牌、产品表达反复引用，应明确标记它需要在 Obsidian `工具工作间/02_场景拆解/外贸业务主干Skill/内部维护` 可见；云端入口只更新两份同步清单
10. **执行同步与验收**：
   - 如果本轮更新了 `../工作间/` 或 `../skill需求池.md`，必须执行 `scripts/sync_obsidian_workspace.sh`
   - 至少核对以下 Obsidian 文件已刷新到最新版本：
     - `工具工作间/02_场景拆解/精选外挂开源Skill/内部维护/开源工具总表.md`
     - `工具工作间/02_场景拆解/精选外挂开源Skill/内部维护/路线映射.md`
     - `工具工作间/02_场景拆解/外贸业务主干Skill/内部维护/skill需求池.md`
