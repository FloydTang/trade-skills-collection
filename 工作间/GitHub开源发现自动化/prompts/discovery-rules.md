...
9. **判断 Obsidian 展现**：
   - 如果某条记录或说明未来会被课程、品牌、产品表达反复引用，应明确标记它需要在 Obsidian `工具工作间/02_场景拆解/外贸skill` 可见
10. **执行同步与验收**：
   - 如果本轮更新了 `../工作间/` 或 `../skill需求池.md`，必须执行 `scripts/sync_obsidian_workspace.sh`
   - 至少核对以下 Obsidian 文件已刷新到最新版本：
     - `工具工作间/02_场景拆解/外贸skill/开源工具总表.md`
     - `工具工作间/02_场景拆解/外贸skill/路线映射.md`
     - `工具工作间/02_场景拆解/外贸skill/skill需求池.md`
