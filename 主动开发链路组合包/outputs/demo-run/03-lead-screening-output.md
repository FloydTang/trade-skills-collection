...
```json
{
  ...
  "notes": "Prefer companies that look ready for private-label frozen food sourcing. | Supplier and importer of frozen vegetables and fruit for private label retail in Poland. | 先进入线索整理，再优先核对官网、LinkedIn 与联系人线索的一致性。 | Evidence Summary: 当前候选主要基于官网、LinkedIn、数据源 fixture形成。 建议动作：ready_for_screening。 | Match Reason: 证据等级 A：来源：fixture；命中搜索查询：frozen food importer Poland importer distributor brand buyer；有官网主体线索；有 LinkedIn 公司页线索；命中当前搜索策略中的目标关键词组合。 | Source URL: https://balticfrozentrade.pl | Source Type: web | Source Name: fixture | Source Note: https://balticfrozentrade.pl | Freshness: unknown | Confidence: medium | Match Basis: 命中搜索查询：frozen food importer Poland importer distributor brand buyer | LinkedIn URL: https://www.linkedin.com/company/baltic-frozen-trade"
}
```
...
```json
{
  ...
  "country_or_market": "Poland",
  "notes": "Prefer companies that look ready for private-label frozen food sourcing. | GreenHarvest Foods imports frozen vegetables for retail and private label programs in Poland. | 先进入线索整理，再优先核对官网、LinkedIn 与联系人线索的一致性。 | Evidence Summary: 当前候选主要基于官网、LinkedIn、2 条可见联系人线索、数据源 fixture形成。 建议动作：ready_for_screening。 | Match Reason: 证据等级 A：来源：fixture；命中搜索查询：frozen mixed vegetables Poland importer；有官网主体线索；有 LinkedIn 公司页线索；搜索结果出现可见联系人或角色线索；命中当前搜索策略中的目标关键词组合。 | Source URL: https://greenharvestfoods.com | Source Type: web | Source Name: fixture | Source Note: https://greenharvestfoods.com | Freshness: unknown | Confidence: medium | Match Basis: 命中搜索查询：frozen mixed vegetables Poland importer | LinkedIn URL: https://www.linkedin.com/company/greenharvestfoods"
}
```
...
```json
{
  ...
  "country_or_market": "Poland",
  "notes": "Prefer companies that look ready for private-label frozen food sourcing. | Importer and distributor of frozen food products in Warsaw. Contact Anna Kowalska for sourcing inquiries. | 先补 LinkedIn 公司页或可见联系人线索，再进入线索整理。 | Evidence Summary: 当前候选主要基于官网、2 条可见联系人线索、数据源 fixture形成。 建议动作：ready_for_screening。 | Match Reason: 证据等级 B：来源：fixture；命中搜索查询：frozen mixed vegetables Poland importer；有官网主体线索；搜索结果出现可见联系人或角色线索；命中当前搜索策略中的目标关键词组合。 | Source URL: https://directory.example/polfood-sourcing | Source Type: web | Source Name: fixture | Source Note: https://directory.example/polfood-sourcing | Freshness: unknown | Confidence: medium | Match Basis: 命中搜索查询：frozen mixed vegetables Poland importer | Review: 公司名与官网域名对应关系较弱，建议人工确认主体匹配。"
}
```
